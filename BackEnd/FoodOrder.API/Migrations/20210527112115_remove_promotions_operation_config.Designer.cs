...
namespace FoodOrder.API.Migrations
{
    ...
    [Migration("20210527112115_remove_promotions_operation_config")]
    partial class remove_promotions_operation_config
    {
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0a6470a4-64c7-4e3a-813b-2fbc1fec9ccf",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ba474cda-4293-4ea5-8a7d-b969d14a5982",
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "36fa296e-740f-4a51-86ae-e1ae7a7eeae0",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDfd+6CtFL3YZO+UCzY29Db9EZ42Sp27034Q+xz7t4nSSyCaVic/RvnENoRBTfMOlg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ac136d9b-7a47-4c7f-b7c3-8423f7e06acb",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEC8AH/2uR6DhGN+6rnDJ6WHOOVev/avbra1XkZbeUOt0HIv45MtPHZ/3of2TUf8cWw==",
                            PhoneNumber = "+111111111",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "messi10"
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressString = "ABC",
                            AppUserID = new Guid("daeb6f0d-eefe-4250-9ecd-28b3243eb684"),
                            CreatedDate = new DateTime(2021, 5, 27, 18, 21, 14, 590, DateTimeKind.Local).AddTicks(7742),
                            IsPaid = false,
                            OrderStatusID = 1,
                            PromotionID = 1
                        });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Promotion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 27, 18, 21, 14, 540, DateTimeKind.Local).AddTicks(3521));
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 27, 18, 21, 14, 542, DateTimeKind.Local).AddTicks(3003));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 27, 18, 21, 14, 542, DateTimeKind.Local).AddTicks(2603));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 100,
                            Code = "THANHVIENMOI",
                            CreatedDate = new DateTime(2021, 5, 27, 18, 21, 14, 592, DateTimeKind.Local).AddTicks(6987),
                            Enabled = true,
                            ...
                            Percent = 0.25f,
                            StartDate = new DateTime(2021, 5, 27, 18, 21, 14, 593, DateTimeKind.Local).AddTicks(472)
                        });
                });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Rating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FoodID = 1,
                            Comment = "Good",
                            LastCreatedTime = new DateTime(2021, 5, 27, 18, 21, 14, 593, DateTimeKind.Local).AddTicks(3895),
                            Star = 5
                        });
                });
