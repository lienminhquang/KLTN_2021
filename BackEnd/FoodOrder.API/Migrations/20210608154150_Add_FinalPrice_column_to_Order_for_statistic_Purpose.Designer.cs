...
namespace FoodOrder.API.Migrations
{
    ...
    [Migration("20210608154150_Add_FinalPrice_column_to_Order_for_statistic_Purpose")]
    partial class Add_FinalPrice_column_to_Order_for_statistic_Purpose
    {
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "50149708-8e37-4319-8cca-b7436706d4f7",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "0688db9b-eac9-4cd1-9273-e8a34363e1df",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "69564adf-db60-44d5-8a92-392744a44cee",
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a3192100-e7f7-4caa-9a56-7389847da0d6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENc5gMBITetNgUbKL5EV2sLblX1mB89EVPkuZ+aeAAe+MJ1AJ4T/uT2VdperuRQWvA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "11112fd9-7449-4f82-b024-f53ce8d21a44",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJaG7V9iPY49DCfTlBl/x7Lx06ny8JUDVydXm4Qz3ey7C0H3ciR4z/MMdsQFi0RBcw==",
                            PhoneNumber = "+111111111",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "messi10"
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressString = "ABC",
                            AppUserID = new Guid("daeb6f0d-eefe-4250-9ecd-28b3243eb684"),
                            CreatedDate = new DateTime(2021, 6, 8, 22, 41, 49, 462, DateTimeKind.Local).AddTicks(3071),
                            FinalTotalPrice = 0.0,
                            IsPaid = false,
                            OrderStatusID = 1,
                            PromotionID = 1
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Promotion", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 8, 22, 41, 49, 423, DateTimeKind.Local).AddTicks(6183));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 8, 22, 41, 49, 422, DateTimeKind.Local).AddTicks(5347));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Percent = 0.25f,
                            Priority = 0,
                            StartDate = new DateTime(2021, 6, 8, 22, 41, 49, 463, DateTimeKind.Local).AddTicks(5266),
                            UseTimes = 100
                        });
                });
