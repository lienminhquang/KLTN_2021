...
namespace FoodOrder.API.Migrations
{
    ...
    [Migration("20210528084523_Add_priority_for_promotion")]
    partial class Add_priority_for_promotion
    {
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "54a6835f-bc2a-4ca0-9e45-8ed528846a9d",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e7b43d88-f9ea-4bef-8e64-238682c0b2fc",
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "604b6133-2b8d-4af0-be4d-9bd4441daebe",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHuj1/PO/IlTn2QydTHqqT667je8/A2+Xn9+QS4gMZr4kWuRKhmI+ef9RLzWb1/QEQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "53edd8d3-4327-4af7-bf80-c5790a80a122",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEYx+cO1nxhYR/A4/gSFTiZ3hzPiBcSyXG33Hth5mAMQ4ymENLXylwsg9r9Wb2ZN3Q==",
                            PhoneNumber = "+111111111",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "messi10"
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressString = "ABC",
                            AppUserID = new Guid("daeb6f0d-eefe-4250-9ecd-28b3243eb684"),
                            CreatedDate = new DateTime(2021, 5, 28, 15, 45, 21, 303, DateTimeKind.Local).AddTicks(8937),
                            IsPaid = false,
                            OrderStatusID = 1,
                            PromotionID = 1
                        });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Promotion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 28, 15, 45, 21, 251, DateTimeKind.Local).AddTicks(7622));
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 28, 15, 45, 21, 252, DateTimeKind.Local).AddTicks(9818));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 28, 15, 45, 21, 252, DateTimeKind.Local).AddTicks(9527));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 100,
                            Code = "THANHVIENMOI",
                            CreatedDate = new DateTime(2021, 5, 28, 15, 45, 21, 305, DateTimeKind.Local).AddTicks(2392),
                            Enabled = true,
                            ...
                            Percent = 0.25f,
                            Priority = 0,
                            StartDate = new DateTime(2021, 5, 28, 15, 45, 21, 305, DateTimeKind.Local).AddTicks(5859)
                        });
                });

            modelBuilder.Entity("FoodOrder.Core.Models.PromotionFood", b =>
                {
                    b.Property<int>("FoodID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FoodID", "PromotionID");

                    b.HasIndex("PromotionID");

                    b.ToTable("PromotionFood");
                });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Rating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FoodID = 1,
                            Comment = "Good",
                            LastCreatedTime = new DateTime(2021, 5, 28, 15, 45, 21, 305, DateTimeKind.Local).AddTicks(9417),
                            Star = 5
                        });
                });
