...
namespace FoodOrder.API.Migrations
{
    ...
    [Migration("20210514092434_ImageDefault")]
    partial class ImageDefault
    {
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ba4fadd6-1f2e-4bb2-89dc-c6dddd543609",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c65b89ed-17a5-461d-ad7f-2c34fbeb69d3",
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2716b524-f977-4461-88b9-4c0bc1930449",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKjtAidzRZn+PGHea8QpHKQ9T/cFgE9ELZWK2+99J9Cg86fmhXIi+kwFGmYivAcYYg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5dfddb37-9eb7-40db-a655-4d6bc116675e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAJFP6w2CSvRRFUpZ9cUw2DYWsJBnKCE8ivDlw3lgoy1jJv4LSzWq0vJNlQueX2CIQ==",
                            PhoneNumber = "+111111111",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "messi10"
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            AppUserID = new Guid("daeb6f0d-eefe-4250-9ecd-28b3243eb684"),
                            CreatedDate = new DateTime(2021, 5, 14, 16, 24, 32, 740, DateTimeKind.Local).AddTicks(885),
                            IsPaid = false,
                            OrderStatusID = 1,
                            PromotionID = 1
                        });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Promotion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 14, 16, 24, 32, 694, DateTimeKind.Local).AddTicks(3584));
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 14, 16, 24, 32, 695, DateTimeKind.Local).AddTicks(9290));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 14, 16, 24, 32, 695, DateTimeKind.Local).AddTicks(8859));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 100,
                            Code = "THANHVIENMOI",
                            CreatedDate = new DateTime(2021, 5, 14, 16, 24, 32, 741, DateTimeKind.Local).AddTicks(5705),
                            Enabled = true,
                            ...
                            Percent = 0.25f,
                            StartDate = new DateTime(2021, 5, 14, 16, 24, 32, 741, DateTimeKind.Local).AddTicks(9292)
                        });
                });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Rating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FoodID = 1,
                            Comment = "Good",
                            LastCreatedTime = new DateTime(2021, 5, 14, 16, 24, 32, 742, DateTimeKind.Local).AddTicks(2857),
                            Star = 5
                        });
                });
