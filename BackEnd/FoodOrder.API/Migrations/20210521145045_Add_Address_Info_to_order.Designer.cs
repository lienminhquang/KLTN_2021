...
namespace FoodOrder.API.Migrations
{
    ...
    [Migration("20210521145045_Add_Address_Info_to_order")]
    partial class Add_Address_Info_to_order
    {
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "eba1fd3c-8cb9-4d36-9566-c1fd680087aa",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "52668b2c-3f5b-4df2-9db7-764be06cce3a",
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4d5874c9-c3a6-4c61-b732-dc929b4350f1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKvBLaDgYy2+jYRDtT1IQpKnjrFw563hUq6z6P9184OVGnIyVmHFfkySH73zPs8nNw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "da7efe52-9555-41d6-bf25-764122573d75",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPD8YI/9ltKUkms2k6Fx4HYQMFIgXuqrM2cNE30XvL7jSefFIiLXPtKIEjn8+NvqbA==",
                            PhoneNumber = "+111111111",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "messi10"
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressString = "ABC",
                            AppUserID = new Guid("daeb6f0d-eefe-4250-9ecd-28b3243eb684"),
                            CreatedDate = new DateTime(2021, 5, 21, 21, 50, 43, 810, DateTimeKind.Local).AddTicks(9936),
                            IsPaid = false,
                            OrderStatusID = 1,
                            PromotionID = 1
                        });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Promotion", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 21, 21, 50, 43, 772, DateTimeKind.Local).AddTicks(5032));
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 21, 21, 50, 43, 774, DateTimeKind.Local).AddTicks(377));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 21, 21, 50, 43, 773, DateTimeKind.Local).AddTicks(9980));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 100,
                            Code = "THANHVIENMOI",
                            CreatedDate = new DateTime(2021, 5, 21, 21, 50, 43, 811, DateTimeKind.Local).AddTicks(9931),
                            Enabled = true,
                            ...
                            Percent = 0.25f,
                            StartDate = new DateTime(2021, 5, 21, 21, 50, 43, 812, DateTimeKind.Local).AddTicks(2495)
                        });
                });
            ...
            modelBuilder.Entity("FoodOrder.Core.Models.Rating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FoodID = 1,
                            Comment = "Good",
                            LastCreatedTime = new DateTime(2021, 5, 21, 21, 50, 43, 812, DateTimeKind.Local).AddTicks(4988),
                            Star = 5
                        });
                });
